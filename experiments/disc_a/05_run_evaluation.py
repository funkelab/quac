...
def main(config_file: str = "configs/stargan.yml"):
    ...
    reports_dir = Path("/nrs/funke/adjavond/projects/duplex/disc_a/reports")
    ...
    for attribution in ["deeplift", "ig"]:
        attribution_dir = (
            Path("/nrs/funke/adjavond/projects/duplex/disc_a/attributions")
            / attribution
        )
        evaluator = Evaluator(
            classifier,
        ...
        report.store(reports_dir / f"{attribution}_report.json")
